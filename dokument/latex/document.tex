...
\subsubsection{Empfohlene Header}\label{empfohlene-header}
...
Für einen OParl-Server EMPFEHLEN wir, bei Anfrage einer Datei die
...
\item
  \texttt{Last-Modified}: Das letzte Änderungsdatum der Datei
\end{itemize}
