...
\NormalTok{\{}
    ...
    \DataTypeTok{"role"}\NormalTok{: \{}
        ...
        \StringTok{"http://oparl.beispielris.de/roles/vorsitzender"}\NormalTok{,}
        \StringTok{"http://oparl.beispielris.de/people/stellvertretender_vorsitzender"}
        \NormalTok{]}
    \NormalTok{\},}
    \DataTypeTok{"members"}\NormalTok{: [}
        ...
        \StringTok{"http://oparl.beispielris.de/people/57"}
    \NormalTok{],}
...
Das selbe Beispiel in kompakter Form. Ein geeigneter Kontext wird
vorausgesetzt:
...
\NormalTok{\{}
    ...
    \DataTypeTok{"@id"}\NormalTok{: }\StringTok{"beispielris:organizations/34"}\NormalTok{,}
    ...
    \DataTypeTok{"name"}\NormalTok{: }\StringTok{"Finanzausschuss"}\NormalTok{,}
    \DataTypeTok{"nameLong"}\NormalTok{: }\StringTok{"Finanzausschuss des Rates der Stadt Köln"}\NormalTok{,}
    \DataTypeTok{"role:"} \ErrorTok{[}
        \DataTypeTok{"beispielris:roles/vorsitzender"}\NormalTok{,}
        \DataTypeTok{"beispielris:roles/stellvertretender_vorsitzender"}
    \ErrorTok{]}\NormalTok{,}
    \DataTypeTok{"members"}\NormalTok{: [}
        \StringTok{"27"}\NormalTok{,}
        \StringTok{"48"}\NormalTok{,}
        \StringTok{"57"}
    \NormalTok{],}
    \DataTypeTok{"last_modified"}\NormalTok{: }\StringTok{"2012-08-16T14:05:27+02:00"}
\NormalTok{\}}
...
\item[\texttt{role}]
Rolle oder Rollen, die für diese Gruppierung vorgesehen sind. Die
Rollen-Objekte gehören zu der Klasse org:Role oder einer ihrer
Unterklassen. OPTIONAL.
\item[\texttt{members}]
...
Das selbe Beispiel in kompakter Form. Ein geeigneter Inhalt des
angegebenen Kontext wird hierbei vorausgesetzt:
...
\NormalTok{\{}
    ...
    \DataTypeTok{"@id"}\NormalTok{: }\StringTok{"beispielris:people/29"}\NormalTok{, }\ErrorTok{//} \ErrorTok{kann} \ErrorTok{möglicherweise} \ErrorTok{weiter} \ErrorTok{gekürzt} \ErrorTok{werden}
    \DataTypeTok{"name"}\NormalTok{: }\StringTok{"Prof. Dr. Max Mustermann"}\NormalTok{,}
    \DataTypeTok{"familyName"}\NormalTok{: }\StringTok{"Mustermann"}\NormalTok{,}
    \DataTypeTok{"givenName"}\NormalTok{: }\StringTok{"Max"}\NormalTok{,}
    \DataTypeTok{"title"}\NormalTok{: }\StringTok{"Prof. Dr."}\NormalTok{,}
    ...
    \DataTypeTok{"postalCode"}\NormalTok{: }\StringTok{"11111"}\NormalTok{,}
    \DataTypeTok{"locality"}\NormalTok{: }\StringTok{"Musterort"}\NormalTok{,}
    \DataTypeTok{"organizations"}\NormalTok{: [}\StringTok{"11"}\NormalTok{, }\StringTok{"34"}\NormalTok{],}
    \DataTypeTok{"created"}\NormalTok{: }\StringTok{"2011-11-11T11:11:00+01:00"}\NormalTok{,}
    \DataTypeTok{"last_modified"}\NormalTok{: }\StringTok{"2012-08-16T14:05:27+02:00"}\NormalTok{,}
\NormalTok{\}}
\end{Highlighting}
...
OPTIONAL.
\item[\texttt{organizations}]
IRIs der Gruppierung oder Liste der IRIs der Gruppierungen (Objekte vom
Typ \texttt{oparl:Organization}), in der bzw. in denen die Person
aktuell Mitglied ist. Diese Eigenschaft ist ZWINGEND. Sollte die Person
Mitglied in keiner Gruppierung sein, enthält die Liste keine Einträge.
\item[\texttt{hasMembership}]
IRIs der Mitgliedschaft oder Liste von IRIs der Mitgliedschaften
...
\NormalTok{\{}
    ...
    \NormalTok{\},}
    \DataTypeTok{"organizations"}\NormalTok{: }\StringTok{"http://oparl.beispielris.de/organizations/34"}\NormalTok{,}
    ...
    \DataTypeTok{"auxiliaryDocuments"}\NormalTok{: [}
...
\NormalTok{\{}
    ...
    \DataTypeTok{"location"}\NormalTok{: \{}
        \DataTypeTok{"description"}\NormalTok{: }\StringTok{"Rathaus, Raum 136"}
    \NormalTok{\},}
    \DataTypeTok{"organizations"}\NormalTok{: }\StringTok{"beispielris:organizations/34"}\NormalTok{,}
    \DataTypeTok{"participants"}\NormalTok{: [}
        \StringTok{"beispielris:people/29"}\NormalTok{,}
        \StringTok{"beispielris:people/75"}\NormalTok{,}
        \StringTok{"beispielris:people/94"}
    \NormalTok{],}
    \DataTypeTok{"invitation"}\NormalTok{: }\StringTok{"beispielris:documents/586"}\NormalTok{,}
    \DataTypeTok{"resultsProtocol"}\NormalTok{: }\StringTok{"beispielris:documents/628"}\NormalTok{,}
    \DataTypeTok{"verbatimProtocol"}\NormalTok{: }\StringTok{"beispielris:documents/691"}\NormalTok{,}
    \DataTypeTok{"attachments"}\NormalTok{: [}
        \StringTok{"beispielris:documents/588"}\NormalTok{,}
        \StringTok{"beispielris:documents/589"}
    \NormalTok{],}
    \DataTypeTok{"agendaItems"}\NormalTok{: [}
        \StringTok{"beispielris:agendaitems/1045"}\NormalTok{,}
        \StringTok{"beispielris:agendaitems/1046"}\NormalTok{,}
        \StringTok{"beispielris:agendaitems/1047"}\NormalTok{,}
        \StringTok{"beispielris:agendaitems/1048"}
    \NormalTok{],}
    \DataTypeTok{"created"}\NormalTok{: }\StringTok{"2012-01-06T12:01:00+01:00"}\NormalTok{,}
    \DataTypeTok{"lastModified"}\NormalTok{: }\StringTok{"2012-01-08T14:05:27+01:00"}
\NormalTok{\}}
...
Eigenschaft ist EMPFOHLEN.
\item[\texttt{organizations}]
IRI der Gruppierung oder Liste der IRIs der Gruppierungen
...
federführende Gremium. Diese Eigenschaft ist ZWINGEND.
\item[\texttt{participants}]
IRI der Gruppierung oder Liste der IRLs der geladenen Teilnehmer
(oparl:Person) der Sitzung. Bei einer stattgefundenen Sitzung SOLL die
Liste nur diejenigen Teilnehmer umfassen, die tatsächlich an der Sitzung
teilgenommen haben. Die Eigenschaft ist ZWINGEND.
...
\NormalTok{\{}
    ...
    \DataTypeTok{"@id"}\NormalTok{: }\StringTok{"http://oparl.beispielris.de/papers/749"}\NormalTok{,}
    ...
    \DataTypeTok{"paperType"}\NormalTok{: }\StringTok{"Beantwortung einer Anfrage"}\NormalTok{,}
    \DataTypeTok{"relatedPapers"}\NormalTok{: [}
        \StringTok{"http://oparl.beispielris.de/papers/699"}
    \NormalTok{],}
    \DataTypeTok{"mainDocument"}\NormalTok{: }\StringTok{"http://oparl.beispielris.de/documents/925"}\NormalTok{,}
    \DataTypeTok{"auxiliaryDocuments"}\NormalTok{: [}
        \StringTok{"http://oparl.beispielris.de/documents/926"}
    \NormalTok{],}
    ...
    \DataTypeTok{"creators"}\NormalTok{: [}
        \StringTok{"beispielris:organizations/2000"}\NormalTok{,}
        \StringTok{"beispielris:people/1000"}
    \NormalTok{],}
    \DataTypeTok{"consultations"}\NormalTok{: [}
        \NormalTok{\{}
            \DataTypeTok{"meeting"}\NormalTok{: }\StringTok{"beispielris:meeting/3271"}\NormalTok{,}
            \DataTypeTok{"agendaitem"}\NormalTok{: }\StringTok{"beispielris:agendaitem/3.1.2"}\NormalTok{,}
            \DataTypeTok{"role"}\NormalTok{: }\StringTok{"Federführende Beratung"}
        \NormalTok{\}}
    \NormalTok{],}
    \DataTypeTok{"lastModified"}\NormalTok{: }\StringTok{"2013-01-08T12:05:27+01:00"}
\NormalTok{\}}
\end{Highlighting}
\end{Shaded}

TODO: * Eigenschaften beschreiben * Eigenschaft ``locations'' im
Beispiel ändern * Eigenschaft ``creators'' im Beispiel ändern *
...
\NormalTok{\{}
    ...
    \DataTypeTok{"committee"}\NormalTok{: }\StringTok{"http://beispielris.de/organizations/96"}\NormalTok{,}
    \DataTypeTok{"authoritative"}\NormalTok{: }\DecValTok{false}
\NormalTok{\}}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{\{}
    ...
    \DataTypeTok{"@id"}\NormalTok{: }\StringTok{"beispielris:consultations/47594"}\NormalTok{,}
    \DataTypeTok{"paper"}\NormalTok{: }\StringTok{"beispielris:papers/2396"}\NormalTok{,}
...
eine mit Liste von Gremien angegeben werden. Die Liste ist dann
geordnet. Das erste Gremium ist federführend. Diese Eigenschaft ist
ZWINGEND.
