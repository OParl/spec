...
\NormalTok{\{}
    ...
    \DataTypeTok{"license_url"}\NormalTok{: }\StringTok{"http://wiki.openstreetmap.org/wiki/DE:Open_Database_Licence_-_Licence_Text"}
\NormalTok{\}}
\end{Highlighting}
\end{Shaded}
...
Beides sollte hier Verwendung finden können. Name (\emph{name}) : Der
Name des Gremiums. Beispiele: ``Rat'', ``Hauptausschuss'',
``Bezirksvertretung 1 (Innenstadt)'' Kurzname (\emph{short\_name}) :
