...
\hyperdef{}{filter}{\subsubsection{Filter}\label{filter}}
...
\hyperdef{}{vokabularux5fex1}{\label{vokabularux5fex1}}
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{\{}
    \ErrorTok{...}
...
Vorsitz der Sitzung Typ: \texttt{oparl:Person}. Kardinalität: 0 bis 1.
EMPFOHLEN.
\item[\texttt{scribe}]
Schriftführer, Protokollant. Typ: \texttt{oparl:Person}. Kardinalität: 0
bis 1. EMPFOHLEN.
...
teilgenommen haben. Typ: Liste von Objekten des Typs
\texttt{oparl:Person}. Vgl. \hyperref[objektlisten]{Objektlisten}.
Kardinalität: 0 bis *. DEPRECATED.
\item[\texttt{invitation}]
Einladungsdokument zur Sitzung. Typ: Liste von Objekten des Typs
...
\hyperdef{}{oparlux5ffile}{\subsection{oparl:File
(Datei)}\label{oparlux5ffile}}
...
\hyperdef{}{fileux5fex1}{\label{fileux5fex1}}
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{\{}
...
\hyperdef{}{oparlux5fmembership}{\subsection{oparl:Membership
(Mitgliedschaft)}\label{oparlux5fmembership}}
